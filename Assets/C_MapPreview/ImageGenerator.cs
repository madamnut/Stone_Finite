// ImageGenerator.cs
// ??Î≥ÄÍ≤? Lava(FLUID_LAVA)Í∞Ä AIR???àÏùÑ ??Îπ®Í∞Ñ?âÏúºÎ°??úÏãú
...
public class ImageGenerator : MonoBehaviour
{
    ...
    public Color unknownColor = new Color(1f, 0f, 1f, 1f); // ÎØ∏Ï????êÎäî ?àÏô∏

    [Header("Name ??Color (?∏Ïä§?ôÌÑ∞?êÏÑú ÏßÅÏ†ë ÏßÄ??")]
    ...
    // Agave(6?Ä?? ?Ä?úÏÉâ(?ÑÎ¶¨Î∑∞Ïóê?????âÏúºÎ°?
    ...
    // ?Ä?Ä Solid IDs (ATT_Solid.json Í∏∞Ï?) ?Ä?Ä
    ...
    // ??Snow additions (ATT_Solid.json Í∏∞Ï?)
    // NOTE: Frozen Dirt ?§Ï†ú IDÎ°?ÎßûÏ∂∞????(?¨Í∏∞??46 Í∞Ä??
    ...
    // ?Ä?Ä Fluid IDs (ATT_Fluid.json Í∏∞Ï?) ?Ä?Ä
    ...
    {
        // ??fluid ?∞ÏÑ† Ï≤òÎ¶¨ (AIR ?ÑÏóêÎß?Î≥¥Ïù¥?ÑÎ°ù)
        if (solidId == ID_AIR)
        {
